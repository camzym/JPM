...
const phoneNumber = await question(color('Masukin No Awal 628 Lipp:\n', 'red'));
...
Skyzo.sendMessage("6287843241782@s.whatsapp.net", {text: "*LixBotz Connect❗*"})
...
if (ff.isGroup == false) {
if (ff.status == "offer") {
let sendcall = await Skyzo.sendMessage(ff.from, {text: `@${ff.from.split("@")[0]} Maaf Kamu Akan Saya Block Karna Ownerbot Menyalakan Fitur *Anticall*\nJika Tidak Sengaja Segera Hubungi Owner Untuk Membuka Blokiran Ini`, contextInfo: {mentionedJid: [ff.from], externalAdReply: {thumbnailUrl: "https://files.catbox.moe/yd74gh.jpg", title: "｢ CALL DETECTED ｣", previewType: "PHOTO"}}}, {quoted: null})
